...
class XLMModel(XLMPreTrainedModel):
    ...
    def _resize_token_embeddings(self, new_num_tokens):
        self.embeddings = self._get_resized_embeddings(
            self.embeddings, new_num_tokens)
    ...
    def forward(self, input_ids, attention_mask=None, langs=None, token_type_ids=None, position_ids=None,
        ...
        tensor = tensor + \
            self.position_embeddings(position_ids).expand_as(tensor)
...
class XLMWithLMHeadModel(XLMPreTrainedModel):
    ...
    def tie_weights(self):
        ...
        self._tie_or_clone_weights(
            self.pred_layer.proj, self.transformer.embeddings)
